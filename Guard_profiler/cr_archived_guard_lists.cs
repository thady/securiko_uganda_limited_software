...
namespace Guard_profiler {
    ...
    public class Cachedcr_archived_guard_lists : Component, ICachedReport {
        
        public Cachedcr_archived_guard_lists() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            cr_archived_guard_lists rpt = new cr_archived_guard_lists();
            rpt.Site = this.Site;
            return rpt;
        }
